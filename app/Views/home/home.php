...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">Fiyu<small>Kedai</small></a>
			...
			<div class="container">
				<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
					...
					<div class="col-md-8 col-sm-12 text-center ftco-animate">
						...
						<p class="mb-4 mb-md-5">Coffee Journey</p>
						<p><a href="https://api.whatsapp.com/send?phone=628111994005" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
					</div>
		...
		<div class="container">
			...
			<?php foreach ($home as $row) : ?>
				<div class="row">
					<div class="col-md-3">
						<div class="menu-entry">
							<a href="" class="img" style="background-image: url(images/menu-1.jpg);"><?php
																										if (!empty($row["gambar"])) {
																											echo '<img src="' . base_url("assets/images/$row[gambar]") . '" height="100px">';
																										}
																										?></a>
							<div class="text text-center pt-4">
								<h3><a href="#">Coffee Capuccino(coba)</a></h3>
								<p>A small river named Duden flows by their place and supplies</p>
				...
				<div class="col-lg-3 col-md-6 mb-5 mb-md-5">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">Soekarno Hatta No.1, Sukabumi Indah, Kec. Sukabumi, Kota Bandar Lampung, Lampung 35122</span></li>
								<li><a href="#"><span class="icon icon-phone"></span><span class="text">0896-0294-1618</span></a></li>
								<!-- <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@yourdomain</span></a></li> -->
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p>
						...
						</script> | <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Dnsannt</a>
						<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					</p>
				</div>
			</div>
