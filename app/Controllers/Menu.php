...
use App\Models\ModelsMenu;

class Menu extends BaseController
{
    public function index()
    {
        $model = new ModelsMenu();
        if (!$this->validate([])) {
    ...
    {
        helper('form');
        return view('menu/view_form');
    }

    public function view($id)
    {
        $model = new ModelsMenu();
        $data['menu'] = $model->PilihMenu($id)->getRow();
    ...
    public function simpan()
    {
        ...
        $model->SimpanMenu($data);
        return redirect()->to('menu/menu')->with('berhasil', 'Data Berhasil di Simpan');
    }
